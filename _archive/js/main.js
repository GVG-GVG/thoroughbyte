  ...
  if (ctxW) {
    new Chart(ctxW, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Win %',
          data: [65.3, 67.9, 56.6, 56.1, 44.5, 40.7],
          backgroundColor: tierColors,
          borderRadius: 4,
          barPercentage: 0.7
        }]
    ...
    new Chart(ctxB, {
      ...
      data: {
        ...
        datasets: [
          ...
          {
            label: 'Stakes Winner %',
            data: [8.0, 5.0, 0.4, 1.0, 0, 0],
            backgroundColor: tierColors.map(function () { return 'rgba(255,255,255,0.15)'; }),
            borderRadius: 4,
            barPercentage: 0.7
          }
        ]
      ...
      options: {
        ...
        scales: {
          ...
          y: {
            ...
            ticks: { color: '#8a9bae', font: { size: 11 }, stepSize: 1 },
  ...
  if (ctxD) {
    new Chart(ctxD, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Avg Earnings',
          data: [138000, 100000, 53000, 66000, 36000, 53000, 46000, 38000, 38000, 28000],
          backgroundColor: [
            '#2d6a4f', '#2d6a4f',
            '#6aae78', '#6aae78',
            '#bfb350', '#bfb350',
